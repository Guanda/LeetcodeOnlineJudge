...
Analysis
Method 1:
	we start from an O(n^2) algorithm where we go backwards, compute the minimum steps for the current element 
	by checking each element within its range to find the next one with smallest number of steps.
