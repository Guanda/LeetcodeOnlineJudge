...
Analysis:
	 using a map to record the locations and their corresponding occurrence
*/
...
class BrickWall {
    public int leastBricks(List<List<Integer>> wall) {
        ...
        for(List<Integer> list : wall) {
            int len = 0;
            // be careful of the size of i, we will ignore the last brick 
            // since we don't want to consider the edge of the wall
